...
Authing 依托万维网之父 **Tim Berners-Lee** 的去中心化社交网络项目 [Solid](https://github.com/solid/solid)，是 Solid 在中国的第一个提供商，我们将推动 Solid 在中国落地，并帮助用户夺回数据控制权。我们在中国搭建了 [Solid 中文社区](https://learnsolid.cn)，以让普通人认识到 Solid 的潜在价值，欢迎加入我们的讨论。
